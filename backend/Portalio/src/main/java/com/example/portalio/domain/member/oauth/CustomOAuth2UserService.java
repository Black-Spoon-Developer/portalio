...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        // OAuth2UserService를 사용하여 oAuthUser 정보를 가져온다.
        OAuth2User oAuth2User = oAuth2UserService.loadUser(userRequest);

        // 클라이언트 등록 ID(google, kakao)와 사용자 이름 속성을 가져온다.
        ...
        if (findMember.isEmpty()) {
            ...
            // 회원의 권한(회원이 존재하지 않으므로 기본권한인 ROLE_USER 넣어준다), 회원속성, 속성이름을 이용해 DefaultOAuthUser 객체를 생성해 반환한다.
        ...
        // 회원의 권한과, 회원속성, 속성이름을 통해 DefaultOAuthUser 객체를 생성해 반환한다.
        return new DefaultOAuth2User(
