...
@ToString
@Builder(access= AccessLevel.PRIVATE) // Builder 메서드를 외부에서 사용하지 않고 내부에서 사용하기 위해 PRIVATE 설정
@Getter
public class OAuth2Attribute {
    ...
    // Google 로그인일 경우 사용하는 메서드, 사용자 정보가 따로 Wrapping 되지 않고 제공되어, 바로 get() 메서드로 접근이 가능함.
    ...
    // kakao 로그인일 경우 사용하는 메서드, 필요한 사용자 정보가 kakaoAccount -> kakaoProfile에 감싸져 있어서, 두번 get() 메서드를 이용해 사용자 정보를 담고 있는 Map을 꺼내야한다.
