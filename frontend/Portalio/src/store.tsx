...
import interviewReducer from "./store/interview/InterviewSlice"; // authSlice 가져오기
import sideTabReducer from "./store/tab/SideTabSlice";

// persist 설정
const persistConfig = {
  key: "root",
  storage,
  whitelist: ["auth", "sideTab", "interview"], // auth, sideTab 슬라이스 추가
};
...
const rootReducer = combineReducers({
  ...
  interview: interviewReducer, // interview 슬라이스 추가
});
