...
// 레포지토리 글쓰기
export const createRepository = async (repositoryData: RepositoryRequest): Promise<RepositoryResponse> => {
...
// 레포지토리 글 수정
export const patchRepository = async (repositoryID: string, repositoryData: RepositoryRequest): Promise<RepositoryResponse> => {
  const state: RootState = store.getState();
  const accessToken = state.auth.accessToken;
