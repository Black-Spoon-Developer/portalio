  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="w-full max-w-4xl min-h-[600px] bg-white rounded-lg shadow-md p-8 relative flex flex-col justify-between">
        <h1 className="text-3xl font-bold mt-4 text-center">AI 모의 면접을 준비해주세요</h1>
          ...
          <div className="flex flex-col space-y-4 mt-4">
            ...
            <div className="flex flex-col items-center justify-center mb-5 text-lg h-[60px]">
              ...
              <div className="flex items-center space-x-4 ">
                <FontAwesomeIcon icon={faMicrophone} className="text-gray-700" />
            ...
            <p className="text-sm text-gray-500 text-center">질문 생성이 완료되면 시작 버튼이 활성화됩니다.</p>
