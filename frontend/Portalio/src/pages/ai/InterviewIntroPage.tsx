    ...
    const observer = new IntersectionObserver(
      (entries) => {
        entries.forEach((entry) => {
          ...
          if (entry.isIntersecting && !entry.target.getAttribute("data-faded")) {
            let opacity = 0;
            let translateY = 20;
      ...
      >
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full text-white px-4">
            <h2 className="text-4xl font-bold mb-4">혹시 면접이 두려우신가요?</h2>
      ...
      >
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full text-white px-4">
            ...
            <p className="text-xl">화상, 음성, 텍스트 면접 중 선택 가능합니다.</p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full text-white px-4">
            ...
            <p className="text-xl">AI로 분석된 피드백을 통해 면접 준비를 완벽하게 하세요.</p>
          </div>
        </div>
      </div>
    </div>
